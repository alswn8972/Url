<template>
  <div class="content">
    <div class="md-layout">
      ...
      <div
          v-if="isHistory"  class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100"
        >
            <chart-card
                        ...
                        <div class="md-layout">
                            ...
                            <div class="md-layout-item md-small-size-100 md-size-20">
                                <div class="places-buttons text-center">
                                    <md-button class="md-info" :disabled="this.urlAvaliable" @click="clickCheckStatus">상태 확인</md-button >
                                </div>
                            </div>
                            ...
                            <div class="md-layout-item md-small-size-100 md-size-100 text-center">
                                <md-button v-if="this.urlAvaliable" @click="clickAddUrl" class="md-raised md-info">등록</md-button>
                            </div>
                        </div>
                    </md-card-content>
                </md-card>
...
export default {
  ...
  data(){
    return{
        ...
        data: {
          ...
          series: [[200, 201, 200, 200, 200, 200, 200]],
        },
        options: {
  ...
  computed:{
    ...mapGetters('url', {urlAvaliable:'getUrlAvailable', urlInit:'getInitAvailable'}),
